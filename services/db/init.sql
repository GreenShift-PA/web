...
CREATE TABLE `green-shift`.`User` (`ID` INT NOT NULL AUTO_INCREMENT , `name` VARCHAR(255) NOT NULL , `firstname` VARCHAR(255) NOT NULL , `email` VARCHAR(510) NOT NULL , `phone` VARCHAR(255) NOT NULL , `country` VARCHAR(255) NOT NULL , `registration` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`ID`)) ENGINE = InnoDB;

-- Ceation of the Message database
CREATE TABLE `green-shift`.`Message` (`ID` INT NOT NULL AUTO_INCREMENT , `from_user_id` INT NOT NULL , `to_user_id` INT NOT NULL , `content` TEXT NOT NULL , PRIMARY KEY (`ID`)) ENGINE = InnoDB;
...
CREATE TABLE `green-shift`.`Tree` (`ID` INT NOT NULL AUTO_INCREMENT , `user_id` INT NOT NULL , `size` INT NOT NULL , PRIMARY KEY (`ID`)) ENGINE = InnoDB;
...
CREATE TABLE `green-shift`.`Post` (`ID` INT NOT NULL AUTO_INCREMENT , `user_id` INT NOT NULL , `tree_id` INT NOT NULL , `title` VARCHAR(255) NOT NULL , `description` TEXT NOT NULL , `likes` INT NOT NULL , `is_valid` BOOLEAN NOT NULL , PRIMARY KEY (`ID`)) ENGINE = InnoDB;
...
CREATE TABLE `green-shift`.`Comment` (`ID` INT NOT NULL AUTO_INCREMENT , `post_id` INT NOT NULL , `user_id` INT NOT NULL , `Description` TEXT NOT NULL , `likes` INT NOT NULL , PRIMARY KEY (`ID`)) ENGINE = InnoDB;
...
CREATE TABLE `green-shift`.`Media` (`ID` INT NOT NULL AUTO_INCREMENT , `post_id` INT NOT NULL , `name` VARCHAR(255) NOT NULL , `type` TEXT NOT NULL , `path` VARCHAR(510) NOT NULL , PRIMARY KEY (`ID`)) ENGINE = InnoDB;
...
CREATE TABLE `green-shift`.`ValidatedBy` (`ID` INT NOT NULL AUTO_INCREMENT , `user_id` INT NOT NULL , `post_id` INT NOT NULL , PRIMARY KEY (`ID`)) ENGINE = InnoDB;
